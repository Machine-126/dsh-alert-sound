...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const DEFAULTS = { volume: 0.7, scope: "all", repeatMs: 20000, notifyEnabled: false, readOutput: false, stallMs: 0, showToast: false, voiceRate: 1, dndEnabled: false, dndStart: 22, dndEnd: 8, types: DEFAULT_TYPES };
    ...
    function apply(ctx) {
      ...
      function SettingsPanel(props) {
        ...
        return react.createElement("div", { style: cardStyle },
          ...
          react.createElement("div", { style: rowStyle },
            react.createElement("span", { style: keyStyle }, "悬浮提示"),
            react.createElement("label", { style: { display: "flex", alignItems: "center", gap: "8px" } },
              react.createElement("input", { type: "checkbox", checked: !!s.showToast, onChange: e => commit(Object.assign({}, s, { showToast: !!e.target.checked })) }),
              react.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, "显示悬浮提示（默认关，以听为主）"))),
          react.createElement("div", { style: rowStyle },
            react.createElement("span", { style: keyStyle }, "语音语速"),
            react.createElement("select", { value: String(s.voiceRate || 1), onChange: e => commit(Object.assign({}, s, { voiceRate: Number(e.target.value) })), style: selStyle },
              react.createElement("option", { value: "0.7" }, "慢"),
              react.createElement("option", { value: "1" }, "标准"),
              react.createElement("option", { value: "1.3" }, "快"))),
          react.createElement("div", { style: rowStyle },
            react.createElement("span", { style: keyStyle }, "勿扰时段"),
            react.createElement("label", { style: { display: "flex", alignItems: "center", gap: "6px" } },
              ...
              react.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, "开启")),
            react.createElement("select", { value: String(s.dndStart), onChange: e => commit(Object.assign({}, s, { dndStart: Number(e.target.value) })), style: selStyle }, hourOpts(s.dndStart)),
            react.createElement("span", { style: { fontSize: 12, opacity: 0.7 } }, "至"),
            react.createElement("select", { value: String(s.dndEnd), onChange: e => commit(Object.assign({}, s, { dndEnd: Number(e.target.value) })), style: selStyle }, hourOpts(s.dndEnd))),
          rows,
