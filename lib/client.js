  ...
  factory: (require) => {
    ...
    const I18N = {
      zh: {
        ...
        "settings.title": "🔔 提醒音设置", "volume": "音量", "scope": "提醒范围", "scope.all": "所有会话", "scope.current": "仅当前会话",
      ...
      en: {
        ...
        "settings.title": "🔔 Alert sounds", "volume": "Volume", "scope": "Scope", "scope.all": "All sessions", "scope.current": "Current session only",
    ...
    function playType(kind, detail) {
      ...
      if (t.sound === "voice") speak(t(kind) + (detail ? "：" + clip(detail, settings.readOutput ? 400 : 120) : ""));
