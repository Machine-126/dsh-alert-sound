...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const DEFAULTS = { volume: 0.7, scope: "all", repeatMs: 20000, notifyEnabled: false, readOutput: false, stallMs: 120000, types: DEFAULT_TYPES };
    ...
    function apply(ctx) {
      ...
      if (slots) {
        ctx.effect(() => slots.inject("settings.section", () => slots.register(
          ...
          props => react.createElement(SettingsPanel, Object.assign({}, props, { getSettings: () => settings, setSettings: persistSettings, subscribeSettings, play: playType, requestNotify: requestNotifyPermission }))
        )));
